...
echo "  "$blue"Facebook:"$c" https://www.facebook.com/your.DaD.06""$blue"    
echo "  "$bule"Github:"$c" https://github.com/ARSecurityTeam"  
...
termux-open-url https://www.facebook.com/your.DaD.06
exit
fi
